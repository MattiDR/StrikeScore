package com.example.strikescore.workerUtils
...
fun makeStatusNotification(message: String, context: Context) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        ...
        val name = "StrikeScoreApp"
        val description = "StrikeScoreApp notifications"
        val importance = NotificationManager.IMPORTANCE_HIGH
        val channel = NotificationChannel("StrikeScoreApp", name, importance)
    ...
    val builder = NotificationCompat.Builder(context, "StrikeScoreApp")
        .setSmallIcon(R.drawable.ic_launcher_foreground)
        .setContentTitle("StrikeScoreApp")
