...
/*Sidenote: to learn more about this TeamApiState object, you can search on LCE (Loading, Content, Error) pattern

When the state is changed to Error, the teamList will not be updated (offline first).
