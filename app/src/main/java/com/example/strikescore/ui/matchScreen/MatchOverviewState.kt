...
/*Sidenote: to learn more about this MatchApiState object, you can search on LCE (Loading, Content, Error) pattern

When the state is changed to Error, the matchList will not be updated (offline first).
